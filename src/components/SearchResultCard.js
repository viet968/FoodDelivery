import { Text, StyleSheet, View,ImageBackground,TouchableOpacity,FlatList  } from 'react-native'
...
export default function SearchResultCard (
    ...
    return (
            ...
            <View style ={styles.view3}>
                ...
                <View style ={{flexDirection:"row"}}>
                    <View style ={styles.view4}>
                        ...
                        <Text style ={styles.text6}>{farAway} Min</Text>
                    </View>
        ...
        <View style ={{marginTop:5,paddingBottom:20}}>
            {/* List product of the restaurant */}
        <FlatList
